...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=96872&cbuster=%%CACHEBUSTER%%&pubUrl=%%REFERRER_URL_ESC%%&x=500&y=347&vp_content=plembedde0xzurhljyk&vp_template=3840&cbuster=1600011139',
					origQString: 's=96872&cbuster=%%CACHEBUSTER%%&pubUrl=%%REFERRER_URL_ESC%%&x=500&y=347&vp_content=plembedde0xzurhljyk&vp_template=3840',
					placementId: 96872,
					x: 500,
					y: 347,
					videoType: 'flow',
